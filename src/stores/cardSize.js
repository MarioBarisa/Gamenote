...
export const useCardSizeStore = defineStore('cardSize', () => {
  ...
  const getSizeConfig = (size) => {
    const configs = {
      small: {
        container: 'grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 2xl:grid-cols-8',
        gap: 'gap-2 sm:gap-3',
        poster: 'aspect-[3/4]',
      ...
      medium: {
        container: 'grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7',
      ...
      large: {
        container: 'grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5',
