    ...
    <div :class="`card-body ${cardSizeStore.getSizeConfig(cardSizeStore.cardSize).cardBody} flex flex-col`">
      ...
      <div class="flex items-center text-xs sm:text-sm mb-2">
        <span class="badge badge-outline p-1 sm:p-2 h-auto">
          <!--NINTENDO SWITCH-->
          <svg v-if="game.platform=='Nintendo Switch' || game.platform=='Nintendo Switch 2'" class="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="nintendo-switch">
        ...
        <span v-if="game.genre" class="badge badge-outline ml-2 p-2 h-auto">
            ...
            <!--Shooter -->
            <p v-if="game.genre && game.genre.includes('Shooter')" title="Shooter">🔫</p>
