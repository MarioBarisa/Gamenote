<template>
  <div class="flex flex-wrap items-center gap-x-1 gap-y-0.5 text-xs opacity-60">
    <span>Ovaj importer koristi community-built</span>
    <a
    ...
    <span>Hvala</span>
    <a class="link link-hover font-medium" href="https://github.com/wescopeland" target="_blank" rel="noopener">Wes Copeland</a>
